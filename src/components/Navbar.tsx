...
const navItems = [
  { name: "Home", path: "/", title: "casashop.tech Homepage - AI Agents & Digital Solutions" },
  ...
  { name: "About", path: "/about", title: "About casashop.tech - Our Story, Mission & Expert Team" },
...
export const Navbar = ({ title = "casashop.tech - AI Agents that transform businesses", description = "We build AI Agents that transform businesses. Increase productivity by 100% through AI integration and boost sales by 100% with our solutions." }: NavbarProps) => {
  ...
  const getPageMetadata = () => {
    ...
    switch(path) {
      case "/services":
        pageTitle = "Services - casashop.tech | AI Agents, Web Development & Digital Solutions";
        ...
        break;
      case "/portfolio":
        pageTitle = "Portfolio - casashop.tech | Our Projects & Case Studies";
        ...
        break;
      case "/about":
        pageTitle = "About Us - casashop.tech | Our Story & Values";
        ...
        break;
      case "/contact":
        pageTitle = "Contact Us - casashop.tech | Get in Touch";
      ...
      default:
        ...
        pageTitle = "casashop.tech | AI Agents that Transform Businesses";
  ...
  const structuredData = {
    ...
    "@type": "Organization",
    "name": "casashop.tech",
    "url": "https://casashop.tech",
    "logo": "https://casashop.tech/favicon.png",
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Canonical URL */}
        <link rel="canonical" href={`https://casashop.tech${location.pathname}`} />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`https://casashop.tech${location.pathname}`} />
        <meta property="og:title" content={pageTitle} />
        <meta property="og:description" content={pageDescription} />
        <meta property="og:image" content="https://casashop.tech/virelity_logo_transparent.png" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content={`https://casashop.tech${location.pathname}`} />
        <meta property="twitter:title" content={pageTitle} />
        <meta property="twitter:description" content={pageDescription} />
        <meta property="twitter:image" content="https://casashop.tech/virelity_logo_transparent.png" />
        ...
        <meta name="author" content="casashop.tech" />
      ...
      >
        <nav className="container flex items-center justify-between" role="navigation" aria-label="Main Navigation">
          <Link
            ...
            aria-label="casashop.tech Homepage"
            title="casashop.tech - AI Agents that Transform Businesses"
          >
            {/* Mobile view: Show favicon only */}
            <img src="/virelity_favicon.png" alt="casashop.tech - AI Agents & Digital Solutions Logo" className="h-12 md:hidden" width="48" height="48" />
            
            {/* Desktop view: Show full navbar logo */}
            <img src="/vireality_navbar.png" alt="casashop.tech - AI Agents & Digital Solutions Company Logo" className="hidden md:block h-10" width="auto" height="40" />
          </Link>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
              <nav className="flex flex-col h-full" aria-label="Mobile Navigation">
                <Link to="/" className="flex items-center gap-2 font-bold py-4 border-b" aria-label="casashop.tech Homepage" title="casashop.tech - AI Agents that Transform Businesses">
                  <img src="/virelity_logo_transparent.png" alt="casashop.tech - AI Agents & Digital Solutions Mobile Logo" className="h-6" width="24" height="24" />
                </Link>
